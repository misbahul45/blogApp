...
const SinglePage =async ({ params }) => {
  ...
  const post=await fetchApiPost(params.slug)
  return (
    <div className="relative min-h-screen flex lg:flex-row flex-col gap-4 items-center justify-center px-4 lg:pt-7 pt-20">
      <button
      onClick={()=>router.back()}
      className="lg:block hidden absolute top-24 left-32 bg-blue-700 px-4 py-1 rounded-md text-slate-200 font-semibold hover:bg-blue-900 transition-all duration-300">
      Back</button>
        <div className="flex-1 flex items-center justify-end lg:pr-7">
          <Image
        ...
        <div className="flex-1 h-full flex flex-col items-center justify-center md:px-0">
